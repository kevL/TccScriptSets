...
//const int TCC_Toggle_AllowSetNameChange			=  1; // not used.
//const int TCC_Value_MaximumSetProperties			=  2; // note: better thought of as "maxSetPARTS"
...
// TCC Property Set vars
//const string TCC_VAR_SET_LABEL	= "tcc_setlabel";
const string TCC_VAR_SET_NOT		= "tcc_setnot";

const string TCC_VAR_SET_PREP_MOD	= "tcc_setflag_mod";
const string TCC_VAR_SET_PREP_ITEM	= "tcc_setflag_item";
const string TCC_VAR_SET_GROUP		= "tcc_setgroup";
...
const string COL_CRAFTING_DISABLED			= "DISABLE";
...
const string COL_BASEITEMS_STACKING			= "Stacking";
const string COL_BASEITEMS_SLOTS			= "EquipableSlots";


// Notification strings
const string NOTE_CRAFT				= "<c=plum>_ Crafting :</c> ";

const string NOTE_RESULT_SUCCESS	= "<c=seagreen><b>SUCCESS</b> :</c> ";
const string NOTE_RESULT_FAIL		= "<c=firebrick><b>FAIL</b> :</c> ";
const string NOTE_RESULT_ERROR		= "<c=firebrick><b>error</b> :</c> ";

const string NOTE_IMBUE_ITEM		= "<c=slateblue>Imbue Item :</c> ";
const string NOTE_II_SPELLID		= "<c=slateblue>Imbued Spell ID :</c> ";
const string NOTE_II_COLOR_SPELL	= " <c=slateblue>( ";
const string NOTE_II_COLOR_CLOSE	= " )</c>";

const string NOTE_SET_REJECTED		= "<c=firebrick>Set rejected :</c> ";
const string NOTE_SET_PREPARED		= "<c=antiquewhite>Set-item is prepared :</c> ";
const string NOTE_SET_PREPITEM		= "<c=antiquewhite>Set-prepared item :</c> ";
const string NOTE_SET_ITEM			= "<c=antiquewhite>Set-item :</c> ";
